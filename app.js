...
const optionDefinitions = [
  ...
  // Firebase options
  {name: 'firebaseAuthFile', alias: 'f', type: filePath, description: 'Provide Firebase authorization file.'},
  {name: 'firebaseURL', alias: 'u', type: String, description: 'Provide database URL in Firebase.'},
  {name: 'databaseAuthVariableOverrideUid', alias: 'o', type: String, description: 'This is a firebase configuration setting. See {underline https://firebase.google.com/docs/database/admin/start} on how to use the setting.'}
];
...
if(options.config) {
  ...
  if(fs.existsSync(__dirname+'/formbuilder.conf.js')) {
    initConfig = require('./formbuilder.conf');
  }
}
